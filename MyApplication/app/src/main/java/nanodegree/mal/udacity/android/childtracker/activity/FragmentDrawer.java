...
import nanodegree.mal.udacity.android.childtracker.adapter.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    public void setFragmentDrawerListener(FragmentDrawerListener drawerListener){
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TypedArray typedArray = getActivity().getResources().obtainTypedArray(R.array.nav_drawer_icons);
